...
async def main():
    ...
    print('eth_balance:', (await client.get_balance(token_address=models.ETH_ADDRESS)))
    print('dai_balance', (await client.get_balance(token_address=models.DAI_ADDRESS)))
    # -----------------------------------------------------------------------------     call example
