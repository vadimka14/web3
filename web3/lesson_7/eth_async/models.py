...
class Networks:
    ...
    Moonbeam = Network(
        ...
        api=API(key=config.MOONBEAM_API_KEY, url='https://api-moonbeam.moonscan.io/api', docs='https://docs.moonbeam.moonscan.io')
    )
    ...
    #     api=API(key=config.COREDAO_API_KEY, url='https://openapi.coredao.org/api', docs='https://docs.coredao.org')
    # )
    ...
    Celo = Network(
        ...
        api=API(key=config.CELO_API_KEY, url='https://explorer.celo.org/mainnet/api', docs='https://explorer.celo.org/mainnet/api-docs')
    )
    ...
    Gnosis = Network(
        ...
        api=API(key=config.GNOSIS_API_KEY, url='https://api.gnosisscan.io/api', docs='http://docs.gnosisscan.io/')
    )
